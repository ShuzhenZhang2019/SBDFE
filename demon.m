...
% 生成superpixel，提取 superpixel 特征
    supnum = ceil(0.12 * edge_num); %  eta=0.135时，IndP:271, Sa:251, Wa:1398
...
flag =1;
[OA(flag),Kappa(flag),AA(flag),CA(:,flag)] = calcError(test_SL(2,:)'-1,label_result(test_id2)'-1,[1:no_classes]);
    OA(flag)
